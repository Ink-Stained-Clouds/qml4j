...
class TextFieldTwoWayClearTest {
    ...
    private static io.github.timer_err.qml4j.engine.binding.Property<String> text(Item root) {
        try {
            return (io.github.timer_err.qml4j.engine.binding.Property<String>) root.getClass().getField("text").get(root);
