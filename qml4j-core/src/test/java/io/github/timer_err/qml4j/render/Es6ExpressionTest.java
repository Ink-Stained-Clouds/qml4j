...
class Es6ExpressionTest {
    ...
    void arrowFunctionStoredInProperty() {
        ...
        assertTrue(f instanceof io.github.timer_err.qml4j.engine.Callable, "expected Callable, got " + f);
        Object out = ((io.github.timer_err.qml4j.engine.Callable) f).call(new Object[]{6L});
