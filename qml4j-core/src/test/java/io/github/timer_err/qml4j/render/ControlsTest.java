...
class ControlsTest {
    ...
    void buttonIsControl() {
        ...
        assertInstanceOf(io.github.timer_err.qml4j.render.items.window.Control.class, root);
        assertInstanceOf(io.github.timer_err.qml4j.render.items.window.AbstractButton.class, root);
    }
    ...
    void labelIsText() {
        ...
        assertInstanceOf(io.github.timer_err.qml4j.render.items.core.Text.class, root);
        Label l = (Label) root;
    ...
    void textFieldIsTextInput() {
        ...
        assertInstanceOf(io.github.timer_err.qml4j.render.items.input.TextInput.class, root);
