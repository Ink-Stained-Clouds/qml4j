...
class WindowTest {
    ...
    void applicationWindowHeaderFooter() {
        ...
        assertInstanceOf(io.github.timer_err.qml4j.render.items.core.Rectangle.class, aw.header.peek());
        assertInstanceOf(io.github.timer_err.qml4j.render.items.core.Rectangle.class, aw.footer.peek());
