package io.qml4j.compiler.bytecode.asm;
...
public final class Descriptors {
    ...
    public static final String PROPERTY_INTERNAL = "io/qml4j/engine/binding/Property";
    public static final String PROPERTY_DESC = "L" + PROPERTY_INTERNAL + ";";
    public static final String BINDING_INTERNAL = "io/qml4j/engine/binding/Binding";
    public static final String SIGNAL_INTERNAL = "io/qml4j/engine/Signal";
    public static final String SIGNAL_DESC = "L" + SIGNAL_INTERNAL + ";";
    public static final String SIGNAL_HANDLER_INTERNAL = "io/qml4j/engine/SignalHandler";
    ...
    public static final String SINK_INTERNAL = "io/qml4j/engine/PropertyChangeSink";
    public static final String QOBJECT_INTERNAL = "io/qml4j/engine/QObject";
